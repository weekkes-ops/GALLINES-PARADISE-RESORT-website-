            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-[#ffffff] p-4 rounded-2xl border border-[#e3dfd6] space-y-1 shadow-sm">
                  <p className="text-xs font-bold text-[#4a5340] uppercase tracking-wider">Classical Estate</p>
                  <p className="text-xs text-[#686762]">Grand pillars, white porticos & private balcony walkways.</p>
                </div>
              </div>
